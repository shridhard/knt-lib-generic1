...
public class TestSecurityHelper1 {
    ...
    public ArrayList<Integer> getRandomArray(int min, int max, int count) {
    ...
    public void testGetRandomArray() {
        ...
        outputVar = getRandomArray(1, 129, 6);
...
//            Logic source : https://stackoverflow.com/questions/21606428/serialize-and-deserialize-an-rsa-public-key
...
//        generateStoreKeys
        ...
        System.out.println(METHOD_NAME + "securityHelper1:testCodesEn:content: " + content + " # algorithm: " + algorithm);
        SecurityHelper1 securityHelper1 = new SecurityHelper1(content, null);
...
//        System.out.println("securityHelper1:testCodesEn:content: " + content);
//        try {
//            String passCode = "$W%Ld0os$3$Wdos3";// String key = "Bar12345Bar12345"; // 128 bit key
//            String encryptedStr = encrypt(content, passCode);
//            System.out.println("passCode: " + passCode + " # encryptedStr: " + encryptedStr);
...
//
//        try {
//            SecretKeySpec keySpec = new SecretKeySpec(strKey.getBytes(StandardCharsets.UTF_8), "AES");
